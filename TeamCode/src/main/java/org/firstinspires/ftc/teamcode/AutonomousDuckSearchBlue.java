...
@Autonomous(name = "AutonomousDuckSearchBlue", group = "Linear Opmode")

//@Disabled
public class AutonomousDuckSearchBlue extends LinearOpMode
{
...
//        }
  ...
  boolean checkForDuck(String currentPos)
  {
    if (opModeIsActive())
    {
