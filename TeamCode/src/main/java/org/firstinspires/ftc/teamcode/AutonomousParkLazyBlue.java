...
@Autonomous(name = "AutonomousParkLazyBlue", group = "Linear Opmode")

//@Disabled
public class AutonomousParkLazyBlue extends LinearOpMode
{
  ...
  public void runOpMode() {
    ...
    MoveToParkSpot.add(new Leg(Leg.Mode.LEFT, 100, 0, 1));
