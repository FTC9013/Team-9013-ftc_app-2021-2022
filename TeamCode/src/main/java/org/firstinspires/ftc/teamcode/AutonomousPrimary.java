...
//  private final double shooterSpeedStop = 0;
  ...
  private final double shooterSpeedFull = 125;
  ...
  public void runOpMode() {
    ...
    NoRingPath.add(new Leg(Leg.Mode.FORWARD,70, 0,0.5));
    NoRingPath.add(new Leg(Leg.Mode.TURN,100, 20,0));
    NoRingPath.add(new Leg(Leg.Mode.FORWARD,70, 0,1.65));
    NoRingPath.add(new Leg(Leg.Mode.LEFT,70, 0,0.15));
    // NoRingPath.add(new Leg(Leg.Mode.TURN,100, 0,0));
    // NoRingPath.add(new Leg(Leg.Mode.RIGHT,35, 0,1.3));
    
    Queue<Leg> NoRingShootingPath = new LinkedList<>();
    NoRingShootingPath.add(new Leg(Leg.Mode.TURN,100, 0,0));
    NoRingShootingPath.add(new Leg(Leg.Mode.RIGHT,70, 0,0.65));
    NoRingShootingPath.add(new Leg(Leg.Mode.FORWARD,50, 0,0.3));
    NoRingShootingPath.add(new Leg(Leg.Mode.BACKWARDS,50, 0,0.3));
    
    // These are the working paths for the OpMode
    Queue<Leg> NoRingReturnPath = new LinkedList<>();
    // PathPt1.add(new Leg(Leg.Mode.FORWARD,35, 0,6.0));
    NoRingReturnPath.add(new Leg(Leg.Mode.TURN,100, 0,0));
    NoRingReturnPath.add(new Leg(Leg.Mode.RIGHT,70, 0,0.7));
    NoRingReturnPath.add(new Leg(Leg.Mode.FORWARD,70, 0,0.25));
    ...
    // PathPt1.add(new Leg(Leg.Mode.FORWARD,35, 0,6.0));
    SingleRingReturnPath.add(new Leg(Leg.Mode.FORWARD,70, 0,0.75));
    
    // These are the working paths for the OpMode
    Queue<Leg> QuadRingPath = new LinkedList<>();
    // PathPt1.add(new Leg(Leg.Mode.FORWARD,35, 0,6.0));
    QuadRingPath.add(new Leg(Leg.Mode.FORWARD,70, 0,0.5));
    QuadRingPath.add(new Leg(Leg.Mode.TURN,100, 20,0));
    QuadRingPath.add(new Leg(Leg.Mode.FORWARD,70, 0,1.65));
    QuadRingPath.add(new Leg(Leg.Mode.TURN,100, 4,0));
    QuadRingPath.add(new Leg(Leg.Mode.FORWARD,70, 0,1.75));
//    QuadRingPath.add(new Leg(Leg.Mode.TURN,100, 0,0));
    ...
    QuadRingShootingPath.add(new Leg(Leg.Mode.BACKWARDS,70, 0,2.5));
    QuadRingShootingPath.add(new Leg(Leg.Mode.RIGHT,70, 0,0.25));
    
    // These are the working paths for the OpMode
    Queue<Leg> QuadRingReturnPath = new LinkedList<>();
    // PathPt1.add(new Leg(Leg.Mode.FORWARD,35, 0,6.0));
    QuadRingReturnPath.add(new Leg(Leg.Mode.FORWARD,70, 0,0.35));
    ...
    for (int rings = 0; rings < 3; ++rings)
    {
      ...
      manipulateTimer.reset();
      while (opModeIsActive() && manipulateTimer.time()< 3);
